...
<body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="me.php">Michael Wahyu Rizky Setiawan</a>
    ...
    <!--nav bar ended-->
   <!--after image part-->
   <div class="container-sm text-center" id="services">
        <div class="container-fluid" id="part_two_two">
            <h3>Welcome To The Developer World</h3>
            <h3>My Skills Are As Follows :</h3>
            <hr>
        </div>
        <div class="container">
